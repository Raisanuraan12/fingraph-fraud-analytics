...
The objective of this document is to define the methodology, query design, scoring logic, and verified execution results for calculating **node-level risk scores** in FinGraph.
